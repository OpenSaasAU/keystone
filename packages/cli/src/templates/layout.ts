...
import {
  ...
  executeSync,
  parse,
} from '@opensaas/keystone-core/graphql'
import type { AdminMetaRootVal } from '@opensaas/keystone-core/types'
import { type StaticAdminMetaQuery, staticAdminMetaQuery } from '@opensaas/keystone-admin-ui/admin-ui/admin-meta-graphql'
