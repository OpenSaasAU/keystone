...
import { type GraphQLSchema } from '@opensaas/keystone-core/graphql'
import { type Entry, walk as _walk } from '@nodelib/fs.walk'

import type { __ResolvedKeystoneConfig, AdminFileToWrite, AdminMetaRootVal } from '@opensaas/keystone-core/types'
import { appTemplate } from '../templates/layout'
