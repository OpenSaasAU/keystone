import  { type InitialisedList,
  ...
  GraphQLNonNull,
  GraphQLScalarType,
  introspectionTypes, } from '@opensaas/keystone-core/lib'
...
const SCALARS = {
  ...
  Int: 'number',
  Float: 'number',
  JSON: `import('@opensaas/keystone-core/types').JSONValue`,
  Decimal: `import('@opensaas/keystone-core/types').Decimal | string`,
} as const
  ...
  return [
    ...
    ...(function* () {
      for (const [listKey, list] of Object.entries(lists)) {
        ...
        yield [
          `export type ${listKey}<Session = any> = import('@opensaas/keystone-core').ListConfig<${listTypeInfoName}<Session>>`,
          `namespace ${listKey} {`,
